...
{
    public class When_perform_transaction
    {
        ...
        public When_perform_transaction()
        {
            ...
            _accountRepository.Setup(x => x.Transfer(It.IsAny<string>(), It.IsAny<float>(), It.IsAny<ETransferType>()));
        ...
        public async void Should_transfer()
        {
            ...
            _accountRepository.Verify(x => x.Transfer(_destinationAccountNumber, _value, ETransferType.Credit));
            _mediator.Verify(x => x.Publish(It.IsAny<DebitTransferConfirmedEvent>(), It.IsAny<CancellationToken>()));
            _mediator.Verify(x => x.Publish(It.IsAny<CreditTransferConfirmedEvent>(), It.IsAny<CancellationToken>()));
        }
    }
}
