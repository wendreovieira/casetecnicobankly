...
{
    public class When_perform_transaction_with_credit_error
    {
        ...
        public When_perform_transaction_with_credit_error()
        {
            ...
            _accountRepository.Setup(x => x.Transfer(It.IsAny<string>(), It.IsAny<float>(), ETransferType.Debit));
            _accountRepository.Setup(x => x.Transfer(It.IsAny<string>(), It.IsAny<float>(), ETransferType.Credit)).Throws(new UnexpectedConnectionErrorException());
